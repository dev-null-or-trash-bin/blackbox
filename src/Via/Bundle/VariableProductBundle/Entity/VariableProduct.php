...
class VariableProduct extends Product implements VariableProductInterface
{
     ...
     *
     * @ORM\OneToMany(targetEntity="Via\Bundle\VariableProductBundle\Entity\Variant", mappedBy="product", cascade={"all"})
     */
    protected $variants;
     ...
     * @var OptionInterface[]
     *
     * * @ORM\ManyToMany(targetEntity="Via\Bundle\VariableProductBundle\Entity\OptionInterface", mappedBy="product", cascade={"all"})
     */
    #protected $options;
